...
class Register extends React.Component{
	...
	onSubmitSignIn = () =>{
		fetch('https://fathomless-bayou-90603.herokuapp.com/register',{
			method: 'post',
			headers: {
		...
		return(
			...
			<main className="pa4 sign black-80">
			    ...
			    <div className="lh-copy center mt3">
			      <p onClick={this.onSubmitSignIn} href="#0" className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer 
			      f6 dib">SignUp</p>
